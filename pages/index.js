        ...
        <Layout>
            ...
            <Container className={"grid md:grid-cols-1 gap-8 py-20"}>
                <div className='md:px-20 flex flex-col items-center'>
                    ...
                    <p className='text-center px-20 mt-4'>
                        I-Salam menyediakan berbagai macam program wakaf yang
                        dikelola secara profesional dan amanah serta diawasi
                        oleh para asatidzah Ahlus Sunnah Wal Jama'ah
                    </p>
                    <Link href='/projects'>
